...
namespace GetTogether.Core.Persistance.Migrations
{
    ...
    [Migration("20190917223644_RolParaEmpleadoCreado")]
    partial class RolParaEmpleadoCreado
    {
            ...
            modelBuilder.Entity("GetTogether.Data.Models.Lugar", b =>
                {
                    ...
                    b.Property<DateTime>("FechaLugar")
                        ...
                        .HasDefaultValue(new DateTime(2019, 9, 17, 17, 36, 44, 627, DateTimeKind.Local).AddTicks(5051));

                    b.Property<DateTime>("FechaLugarModificacion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2019, 9, 17, 17, 36, 44, 636, DateTimeKind.Local).AddTicks(8067));
            ...
            modelBuilder.Entity("GetTogether.Data.Models.OpcionComida", b =>
                {
                    ...
                    b.Property<DateTime>("FechaOpcion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2019, 9, 17, 17, 36, 44, 641, DateTimeKind.Local).AddTicks(6915));

                    b.Property<DateTime>("FechaOpcionModificacion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2019, 9, 17, 17, 36, 44, 641, DateTimeKind.Local).AddTicks(8100));
            ...
            modelBuilder.Entity("GetTogether.Data.Models.Votacion", b =>
                {
                    ...
                    b.Property<DateTime>("FechaModificacion")
                        ...
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2019, 9, 17, 17, 36, 44, 642, DateTimeKind.Local).AddTicks(9156));

                    b.Property<DateTime>("FechaRegistro")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2019, 9, 17, 17, 36, 44, 642, DateTimeKind.Local).AddTicks(7845));
