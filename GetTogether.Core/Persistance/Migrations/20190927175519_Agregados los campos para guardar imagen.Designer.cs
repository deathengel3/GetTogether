...
namespace GetTogether.Core.Persistance.Migrations
{
    ...
    [Migration("20190927175519_Agregados los campos para guardar imagen")]
    partial class Agregadosloscamposparaguardarimagen
    {
            ...
            modelBuilder.Entity("GetTogether.Data.Models.Lugar", b =>
                {
                    ...
                    b.Property<DateTime>("FechaLugar")
                        ...
                        .HasDefaultValue(new DateTime(2019, 9, 27, 12, 55, 18, 848, DateTimeKind.Local).AddTicks(3795));

                    b.Property<DateTime>("FechaLugarModificacion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2019, 9, 27, 12, 55, 18, 859, DateTimeKind.Local).AddTicks(4744));
            ...
            modelBuilder.Entity("GetTogether.Data.Models.OpcionComida", b =>
                {
                    ...
                    b.Property<DateTime>("FechaOpcion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2019, 9, 27, 12, 55, 18, 863, DateTimeKind.Local).AddTicks(9821));

                    b.Property<DateTime>("FechaOpcionModificacion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2019, 9, 27, 12, 55, 18, 864, DateTimeKind.Local).AddTicks(951));
            ...
            modelBuilder.Entity("GetTogether.Data.Models.Votacion", b =>
                {
                    ...
                    b.Property<DateTime>("FechaModificacion")
                        ...
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2019, 9, 27, 12, 55, 18, 865, DateTimeKind.Local).AddTicks(210));

                    b.Property<DateTime>("FechaRegistro")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2019, 9, 27, 12, 55, 18, 864, DateTimeKind.Local).AddTicks(9115));
