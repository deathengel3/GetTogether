...
namespace GetTogether.Data.Persistance.Contexts
{
    public class AppDbcontext : DbContext
    {
        public DbSet<Empleado> Empleados { get; set; }
        public DbSet<Lugar> Lugares { get; set; }
        public DbSet<OpcionComida> OpcionComidas { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Lugar>().Property(l => l.IdLugar).IsRequired().ValueGeneratedOnAdd();
            builder.Entity<Lugar>().Property(l => l.NombreLugar).IsRequired().HasMaxLength(250);
            builder.Entity<Lugar>().Property(l => l.DireccionLugar).IsRequired().HasMaxLength(250);
            builder.Entity<Lugar>().Property(l => l.FechaLugar).IsRequired().HasDefaultValue(DateTime.Now).ValueGeneratedOnAdd();
            builder.Entity<Lugar>().HasMany<OpcionComida>(l => l.OpcionesComida).WithOne(l => l.Lugar).HasForeignKey(p => p.LugarId);

            builder.Entity<OpcionComida>().ToTable("OpcionComidas");
            ...
            //builder.Entity<Votacion>().HasOne<Empleado>(v => v.Empleado).WithMany(v => v.)
